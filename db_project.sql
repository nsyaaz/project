...
(3, 'jus strawberry', 20000, 'tidak tersedia'),
...
INSERT INTO `transaksi` (`id_transaksi`, `kode_menu`, `id_karyawan`, `nama_pelanggan`, `tanggal`, `nama_menu`, `harga`, `jumlah_beli`, `total_bayar`, `nama_kasir`) VALUES
(1, 1, 3, 'yudis', '2024-05-01', 'kopi', 20000, 2, 40000, 'najwa'),
(2, 2, 2, 'laras', '2024-05-08', 'jus jeruk', 10000, 2, 20000, 'yudis'),
(3, 2, 3, 'Fer', '2024-05-05', 'jus jeruk', 10000, 2, 20000, 'najwa'),
(4, 4, 3, 'ras', '2024-05-16', 'mie goreng', 10000, 2, 20000, 'najwa'),
(5, 1, 3, 'henri mudi', '2024-05-01', 'kopi', 20000, 2, 40000, 'najwa');
